const stylist = [
    ...
    email: '', 
    website: '', 
    image: 'images/jackie-epperson.jpg', 
    ...
    email: '', 
    website: '', 
    image: 'images/elizabethJacobson.jpg', 
    ...
    email: '', 
    website: '', 
    image: 'images/stevieJo.jpg', 
    bio: "Chroma Salon is thrilled to welcome Stevie to their team of talented stylists! Having been a friend and client of the salon for many years, Stevie is excited to bring her skills and passion for hair to the Chroma team. She is a dedicated stylist and colorist, with a keen eye for detail and a commitment to delivering exceptional results. Stevie is constantly expanding her knowledge and honing her craft through continued education, and is always eager to learn new techniques and stay on top of the latest trends. Her enthusiasm and creativity make her a great addition to the Chroma Salon team, and clients can trust that they're in good hands with Stevie."
    },
    {name: 'Ashley Shin', 
    title: 'Stylist', 
    phone: '253652880', 
    ...
    email: '', 
    website: '', 
    image: 'images/crystalCoralles.jpg', 
    ...
    email: '', 
    website: '', 
    image: 'images/brendaPaige.jpg', 
    bio: "Brenda is a talented and fun-loving hairstylist who brings 17+ years of experience to Chroma Salon. Her ability to make her clients feel beautiful and comfortable in her chair is second to none, and she has a knack for creating customized looks that perfectly suit each person's style and personality. Brenda is well-versed in a range of hair services, including balayage, foils, cuts, and extensions, and she is always up-to-date on the latest techniques and trends. She takes the time to listen to her clients' needs and preferences, and works closely with them to achieve their desired look. With Brenda, you can trust that you're in good hands, whether you're looking for a subtle change or a bold new style. Her passion for hair and dedication to delivering exceptional results make her a valued member of the Chroma Salon team, and clients love the energy and positivity she brings to every appointment."
    },
    {name: 'Gabi Torgerson', 
    title: 'Stylist', 
    phone: '2532797044', 
    ...
    email: '', 
    website: '', 
    image: 'images/gabiTorgerson.jpg', 
...
let stylistDiv = document.querySelector('.stylistsContainer')

for(let i = 0; i < list.length; i++){
//create each card
    let card = document.createElement('div')
    card.classList.add('stylistCard')
    stylistDiv.appendChild(card)
//image
    let image = document.createElement('img')
    
    image.src = list[i].image
    image.classList.add('stylistImg')
    card.appendChild(image)
//name
    let name = document.createElement('h2')
    name.classList.add('stylistName')
...
//links
    if(list[i].facebook != ''){
        ...
        linkFacebook.classList.add('link')
        linkFacebook.innerHTML = `<image src='images/f_logo_RGB-Black_58.png'>`
        linkFacebook.href = list[i].facebook
        card.appendChild(linkFacebook)
    }
    if(list[i].instagram != ''){
        let linkInstagram = document.createElement('a')
        linkInstagram.classList.add('link')
        linkInstagram.innerHTML = `<image class='socialLink' src='images/Instagram_Glyph_Black.png'>`
        linkInstagram.href = list[i].instagram
        card.appendChild(linkInstagram)
    }
    if(list[i].website != ''){
